...
export function PrivacyPage() {
  return <main className="screen active result-page"><div className="shell result-wrap">
    ...
    <article className="result-section legal-document" aria-labelledby="privacy-title">
      ...
      <h2>外部サービス</h2><p>本サービスは、決済処理にStripe、データ保存にFirebaseおよびGoogle Cloud、WebサイトとAPIの提供にVercelを利用します。これらの事業者では、各社の規約およびプライバシーポリシーに基づいて情報が取り扱われます。サービス運営上必要となる場合は、その他の委託先を利用することがあります。</p>
